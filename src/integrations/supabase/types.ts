    ...
    Tables: {
      properties: {
        Row: {
          ...
          hvac_specific_age: string | null
          id: string
          include_financial_breakdown: boolean | null
          lot_size: string | null
          memo_filed: boolean | null
          office_number: string | null
          photo_link: string | null
          pool: boolean | null
          post_possession: boolean | null
          rehab_estimate: string | null
          roof_age: string | null
          roof_condition: string | null
          roof_last_serviced: string | null
          roof_specific_age: string | null
          ...
          water_heater_last_serviced: string | null
          water_heater_specific_age: string | null
          website: string | null
