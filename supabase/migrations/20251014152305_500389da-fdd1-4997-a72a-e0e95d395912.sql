...
-- Phase 2: Modify existing columns
-- Convert pool from text to boolean
ALTER TABLE public.properties 
...
-- Convert utilities from text to jsonb array
ALTER TABLE public.properties 
...
-- Phase 3: Drop obsolete column
ALTER TABLE public.properties DROP COLUMN IF EXISTS garage;

-- Phase 4: Drop and recreate get_public_property_data function with new signature
...
-- Phase 5: Replace secure_upsert_property function to handle all fields
